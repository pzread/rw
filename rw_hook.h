...
extern int rw_cache_load(struct rw_cache_info *ca_info,struct block_device *bdev,sector_t start,unsigned long rw,unsigned int size);
extern int rw_cache_scan(struct rw_cache_info *ca_info,unsigned long start,unsigned long free_limit,unsigned long write_limit,unsigned int flags,unsigned long *next_start);
