...
static DEFINE_MUTEX(hook_info_hash_mutex);
...
extern u8* rw_cache_alloc_sector(void);
...
extern int rw_cache_writeback(struct rw_cache_info *ca_info,unsigned long limit_cluster);
